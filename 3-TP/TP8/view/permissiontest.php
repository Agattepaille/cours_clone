...
// Appeler la fonction userRole pour obtenir le rôle de l'utilisateur
$userRole = DBManagement::userRole($user_ID);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        /* styles CSS pour masquer toutes les divs par défaut */
        .role-div {
            display: none;
        }
        /* Montrer la div correspondante au rôle de l'utilisateur */
        <?php echo $userRole ? ".role-" . strtolower($userRole) . " { display: block; }" : ''; ?>
    </style>
</head>
<body>
    <div class="role-div role-admin">
        <h2>Admin content, test purpose</h2>
    </div>
    <div class="role-div role-moderator">
        <h2>Moderator content, test purpose</h2>
    </div>
    <div class="role-div role-auditor">
        <h2>Auditor content, test purpose</h2>
    </div>
<body>
    ...
    <div class="page-content">
        ...
        <thead>
            <tr>
                ...
                <th>Add Penality</th>
                <th>Add Delay</th>
                <th class="role-div role-admin">Delete</th>
            </tr>
        </thead>
        <tbody>
